...
class Game:
	...
	def __init__(self):
		...
		# input handling for older pygame versions
	...
	def get_just_pressed(self):
		"""Custom implementation of get_just_pressed for older pygame versions"""
		current_keys = pygame.key.get_pressed()
		just_pressed = {}
		for key in range(len(current_keys)):
			if current_keys[key] and not self.last_keys[key]:
